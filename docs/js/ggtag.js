...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
    ...
    var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'docs/js/ggtag.data';
      var REMOTE_PACKAGE_BASE = 'ggtag.data';
...
Module['FS_createPath']("/", "host", true, true);
Module['FS_createPath']("/host", "fonts", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_docs/js/ggtag.data');

      };
      Module['addRunDependency']('datafile_docs/js/ggtag.data');
    ...
    loadPackage({"files": [{"filename": "/host/fonts/fa-solid-900.ttf", "start": 0, "end": 202744}], "remote_package_size": 202744});
...
/** @type {function(...*):?} */
var _renderCodepoint = Module["_renderCodepoint"] = createExportWrapper("renderCodepoint");
