...
ifeq ($(CXX),emcc)
	EMFLAGS = -s EXPORTED_FUNCTIONS='["_render","_renderCodepoint","_encode","_malloc","_free"]' -s EXPORTED_RUNTIME_METHODS='["ccall","getValue"]' -s ALLOW_MEMORY_GROWTH=1 --preload-file host/fonts/fa-solid-900.ttf
