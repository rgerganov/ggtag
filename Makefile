...
ifeq ($(CXX),emcc)
	EMFLAGS = -s EXPORTED_FUNCTIONS='["_render","_encode","_monoimage","_getLastError", "_debugEnable", "_malloc","_free"]' -s EXPORTED_RUNTIME_METHODS='["ccall","getValue","UTF8ToString"]' -s ALLOW_MEMORY_GROWTH=1
